...
p diag(4,"0.10",s,mn)   u 1:($2*R($1,0.1))  w lp lt 1 t "k/T=.1"  ,\
  ...
  diag(4,"0.10",s,mn)   u (cut($1,1)):(($3+$4)*R($1,0.1)) w l ls 1 t "OPE" ,\
  diag(4,"1.00",s,mn)   u (cut($1,2)):(($3+$4)*R($1,1.))  w l ls 2 t " " ,\
  diag(4,"10.00",s,mn)  u (cut($1,11)):(($3+$4)*R($1,10.)) w l ls 3 t " " 
